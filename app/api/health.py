...
async def health_check(
    services: Optional[bool] = Query(
        False,
        description="If true, check all external services"
    )
    ...
    try:
        ...
        if (
            ...
            or state_db_status == "error"
            or openai_status == "unavailable"
        ):
...
async def check_vector_database() -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(
            f"Vector database check failed: {e}"
        )
...
async def check_state_database() -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(
            "State database check completed"
        )
        ...
        logger.error(
            f"State database check failed: {e}"
        )
...
async def detailed_health_check() -> Dict[str, Any]:
    ...
    with component-specific information.
    """
